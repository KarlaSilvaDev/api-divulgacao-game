...
function changeAbilityAcrobat() {
    ...
    document.getElementById("ability-acrobat").style.border = "#05D9E8 solid 3px";
    document.getElementById("title-ability").innerHTML = "Acrobata urbano";
    document.getElementById("summary-ability").innerHTML = "Habilidade exclusiva voltada para mobilidade e destreza. Suas capacidades incluem a criação de hologramas de distração, implantes cibernéticos que permitem saltos acrobáticos, garras magnéticas para escalada e deslizadores urbanos nas solas dos sapatos. ";
...
function changeAbilitySniper() {
    ...
    document.getElementById('ability-hacker').style.border = 'none';
    document.getElementById('ability-engineer').style.border = 'none';
    document.getElementById("ability-sniper").style.border = " #05D9E8 solid 3px";
    document.getElementById("title-ability").innerHTML = "Atiradora de Elite";
...
function changeAbilityEngineer() {
    ...
    document.getElementById("ability-engineer").style.border = " #05D9E8 solid 3px";
...
function changeAbilityHacker() {
    ...
    document.getElementById("ability-hacker").style.border = " #05D9E8 solid 3px";
...
function changeAbilityMaster() {
    ...
    document.getElementById("verMais2").innerHTML = ""
    document.getElementById("verMais3").innerHTML = ""
    document.getElementById("ability-master").style.border = "#05D9E8 solid 3px";
    document.getElementById("title-ability").innerHTML = "Mestra em Combate";
    document.getElementById("summary-ability").innerHTML = "A Mestra em Combate é uma guerreira habilidosa em um cenário futurista, destacando-se por suas proezas físicas e expertise em diversas formas de combate. Sua presença no campo de batalha é marcada por uma combinação única de força bruta, agilidade impressionante e táticas de combate estratégicas.";
    // document.getElementById("img-personagem-home").src = "/static/img/personagens/mestra.jpg";
    if (document.getElementById("verMais1").innerHTML === "") {
        document.getElementById("verMais").style.display = "block";
...
function verMais() {
    ...
    else if (document.getElementById("title-ability").innerHTML === "Mestra em combate") {
